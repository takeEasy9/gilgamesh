...
import com.gilgamesh.common.enums.NameValueEnum;
...
public class ResponseUtil {
    ...
    public static Map<String, Object> success(NameValueEnum<String> codeMsg, Object data) {
        ...
        resultMap.put(SystemEnums.ApiRes.CODE.getValue(), codeMsg.getValue());
        resultMap.put(SystemEnums.ApiRes.MESSAGE.getValue(), codeMsg.getName());
    ...
    public static Map<String, Object> failed(CodeMsg codeMsg) {
        ...
        resultMap.put(SystemEnums.ApiRes.CODE.getValue(), codeMsg.getClass());
